...
```plaintext
Using launch settings from C:\krk\mcp\mcp-csharp-template\src\Client\Properties\launchSettings.json...
...
"mcp-csharp-template": {
	...
	"args": [
		"run",
		"--project",
		"C:\\krk\\mcp\\mcp-csharp-template\\src\\Server\\Server.csproj"
	]
}
```
...
"mcp-csharp-template": {
    ...
    "args": [
        ...
        "--no-build",
        "--project",
        "C:\\krk\\mcp\\mcp-csharp-template\\src\\Server"
    ]
}
```
